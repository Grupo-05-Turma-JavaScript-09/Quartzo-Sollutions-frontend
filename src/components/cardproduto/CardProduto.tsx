    ...
    <section className="bg-gray-50 py-16 px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
        ...
        <div className="group bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center transform hover:-translate-y-2 transition-all duration-300">
          ...
          <Link to="/servicos/Recrutamento%20&%20Seleção">
            <button className="bg-linear-to-r from-cyan-500 to-blue-500 text-white font-semibold px-5 py-2 rounded-full shadow-md hover:opacity-90 transition-all duration-300">
              Saiba mais
            </button>
          </Link>
        </div>
        ...
        <div className="group bg-linear-to-br from-blue-900 to-blue-800 p-8 rounded-2xl shadow-xl text-center transform hover:-translate-y-2 transition-all duration-300">
          ...
          <Link to="/servicos/Treinamento%20&%20Desenvolvimento">
        ...
        <div className="group bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center transform hover:-translate-y-2 transition-all duration-300">
          ...
          <Link to="/servicos/Gestão%20de%20Desempenho">
            <button className="bg-linear-to-r from-cyan-500 to-blue-600 text-white font-semibold px-5 py-2 rounded-full shadow-md hover:opacity-90 transition-all duration-300">
              Saiba mais
            </button>
          </Link>
        </div>
        ...
        {/* Pesquisa de Clima */}
        <div className="group bg-linear-to-br from-cyan-500 to-blue-600 p-8 rounded-2xl shadow-xl text-center transform hover:-translate-y-2 transition-all duration-300">
          <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          <Link to="/servicos/Pesquisa%20de%20Clima">
            <button className="bg-white text-blue-900 font-semibold px-5 py-2 rounded-full shadow-md hover:bg-blue-100 transition-all duration-300">
              Saiba mais
            </button>
          </Link>
        ...
        {/* Cargos e Salários */}
        <div className="group bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center transform hover:-translate-y-2 transition-all duration-300">
          <div className="w-20 h-20 bg-linear-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
            <span className="text-white text-2xl font-bold">🤝</span>
          </div>
          <h3 className="text-2xl font-bold text-blue-900 mb-4">
            Cargos e Salários
          ...
          <Link to="/servicos/Cargos%20e%20Salários">
            <button className="bg-linear-to-r from-blue-600 to-blue-800 text-white font-semibold px-5 py-2 rounded-full shadow-md hover:opacity-90 transition-all duration-300">
              Saiba mais
            </button>
          </Link>
        </div>
